...
<%@ page import="com.event.scheduler.service.ResourceService" %>
<%@ page import="com.event.scheduler.service.impl.ResourceServiceImpl" %>
...
<%
    ...
    if (resourceIdParameter == null ||
            resourceIdParameter.trim().isEmpty()) {

        response.sendRedirect("admin/resources");
        return;
    }
    ...
    try {
        ...
        resourceId =
                Integer.parseInt(resourceIdParameter);
